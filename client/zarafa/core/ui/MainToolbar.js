...
Zarafa.core.ui.MainToolbar = Ext.extend(Zarafa.core.ui.Toolbar, {
	...
	onUndoStackChange: function(undoManager)
	{
		...
		// Descriptions are plain text: the Ext.QuickTip override encodes what
		// it shows, and the _() templates come back encoded, so decode them.
